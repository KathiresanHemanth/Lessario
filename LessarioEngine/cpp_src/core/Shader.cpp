...
namespace Lessario {
    ...
    Shader::Shader(const std::string& vertexPath, const std::string& fragmentPath) {
        ...
        try {
            ...
            std::cerr << "[Shader] ERROR::SHADER::FILE_NOT_SUCCESFULLY_READ: " << e.what() << std::endl;
        }
    ...
    void Shader::checkCompileErrors(unsigned int shader, const std::string& type) const {
        ...
        if (type != "PROGRAM") {
            ...
            if (!success) {
                ...
                std::cerr << "[Shader] ERROR::SHADER_COMPILATION_ERROR of type: " << type << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
            }
        }
        else {
            ...
            if (!success) {
                ...
                std::cerr << "[Shader] ERROR::PROGRAM_LINKING_ERROR of type: " << type << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
            }
        }
    }
