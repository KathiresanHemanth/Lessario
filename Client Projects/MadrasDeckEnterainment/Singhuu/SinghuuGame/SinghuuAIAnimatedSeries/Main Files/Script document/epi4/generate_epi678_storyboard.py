...
def parse_and_generate_storyboard(pdf_name, out_name):
    ...
    out_lines.append(f'This file contains the complete breakdown of frames for Storyboarding.\n')
    ...
    for line in lines:
        ...
        if len(line) > 20 and not line.startswith('“'):
            ...
            prompt = f'`3D animated movie style frame. Medium shot. {line}. Cinematic lighting, vibrant colors. Pixar style.`'
            out_lines.append(f'**Shot {shot_counter}: Medium Shot**')
...
try:
    parse_and_generate_storyboard('Singu - The Raja_E6_A Panic Wave.pdf', 'Episode6_Storyboard_Prompts.md')
    print('Episode 6 done')
    parse_and_generate_storyboard('Singu - The Raja_E7_The Unstoppable Force.pdf', 'Episode7_Storyboard_Prompts.md')
    print('Episode 7 done')
    parse_and_generate_storyboard('Singu - The Raja_E8_A Territory War.pdf', 'Episode8_Storyboard_Prompts.md')
