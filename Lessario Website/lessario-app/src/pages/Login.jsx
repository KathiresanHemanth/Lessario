...
export default function Login() {
    ...
    useEffect(() => {
        ...
        if (window.google) {
            ...
            google.accounts.id.renderButton(
                ...
                { theme: "outline", size: "large", width: "100%", text: "continue_with", shape: "circle" }
            );
        }
    }, []);
    ...
    return (
        <div style={{ paddingTop: '120px', minHeight: '100vh', backgroundColor: 'var(--bg-page)', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0 2rem' }}>
            <div className="card" style={{ maxWidth: '440px', width: '100%', padding: '3rem 2.5rem' }}>
                <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                    ...
                    <h1 style={{ fontSize: '2rem', fontWeight: 600, letterSpacing: '-0.03em', marginBottom: '0.5rem' }}>Experience Lessario</h1>
                    <p style={{ color: 'var(--text-muted)' }}>Sign in to access your studio profile</p>
                </div>
                    ...
                    <div style={{ marginBottom: '1rem' }}>
                        <input
                            ...
                            style={{
                                ...
                                backgroundColor: 'var(--bg-page)', fontSize: '1rem', outline: 'none', appearance: 'none',
